...
it('classifies kludge lines', function () {
...
it('classifies tearlines', function () {
    $classifier = new LineClassifier;
...
it('classifies origin lines', function () {
    $classifier = new LineClassifier;

    expect($classifier->classify(' * Origin: Goldware BBS (2:236/77)'))->toBe(LineType::Origin);
});

it('classifies odd-depth quotes as Quote1', function () {
    $classifier = new LineClassifier;
...
it('classifies even-depth quotes as Quote2', function () {
    $classifier = new LineClassifier;
...
it('classifies normal lines', function () {
    $classifier = new LineClassifier;
