...
- The application is served by Laravel Herd at `https://golded-app.test`. Use the `get-absolute-url` tool to generate valid URLs. Never run commands to serve the site. It is always available.
